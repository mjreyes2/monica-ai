...
try:
    from monica_ai.src.utils.location_services import get_location_services
...
class GoogleMapsIntegration:
    ...
    def __init__(self):
        # Google Maps JavaScript API key — set GOOGLE_MAPS_API_KEY in your .env file
    ...
    def geocode_location(self, location_name: str) -> Optional[Dict]:
        ...
        if not self.api_key:
            # Fallback: Use free OpenStreetMap Nominatim
