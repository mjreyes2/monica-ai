...
try:
    ...
    from ui.monica_global_webcams import get_webcam_network
...
try:
    ...
    from services.monica_earth_data import get_earth_data
...
try:
    ...
    from services.monica_google_maps_globe import get_google_maps_globe
...
try:
    ...
    from ui.monica_free_maps import get_free_maps
...
try:
    ...
    from ui.monica_realistic_globe import get_realistic_globe, RealisticGlobeRenderer
...
try:
    ...
    print("[OK] Satellite Data System loaded (accurate geocoding)")

except ImportError as e:

    print(f"[WARN] Satellite Data System not available: {e}")
...
try:
    ...
    print("[OK] Research System loaded (scholarly search, multi-language)")

except ImportError as e:

    print(f"[WARN] Research System not available: {e}")
...
try:
    ...
    from core.monica_orb_window import get_orb_window, MonicaOrbWindow

    HAS_ORB_WINDOW = True

    print("[OK] Orb Window loaded (green screen for OBS)")

except ImportError as e:

    print(f"[WARN] Orb Window not available: {e}")
...
try:
    ...
    from ui.monica_globe_window import get_globe_window, MonicaGlobeWindow

    HAS_GLOBE_WINDOW = True

    print("[OK] Globe Window loaded (green screen for OBS)")

except ImportError as e:

    print(f"[WARN] Globe Window not available: {e}")
...
try:
    ...
    from services.monica_keyboard_window import get_keyboard_window, MonicaKeyboardWindow

    HAS_KEYBOARD_WINDOW = True

    print("[OK] Keyboard Window loaded (green screen for OBS)")

except ImportError as e:

    print(f"[WARN] Keyboard Window not available: {e}")
...
try:
    ...
    from services.monica_dial_window import get_dial_window, MonicaDialWindow

    HAS_DIAL_WINDOW = True

    print("[OK] Dial Window loaded (green screen for OBS)")

except ImportError as e:

    print(f"[WARN] Dial Window not available: {e}")
...
class MonicaARHologramSystem:
    ...
    def __init__(self):
        ...
        print("[OK] AR Hologram System initialized (optimized)")
    ...
    def trigger_alarm(self):
        ...
        print("[AR] [ALERT] ALARM TRIGGERED!")
    ...
    def highlight_landmass(self, region: str) -> str:
        ...
        from ui.monica_realistic_globe import REGION_BOUNDS
    ...
    def render_overlay(self, frame: np.ndarray) -> np.ndarray:
        ...
        #     from src.core.monica_orb_window import OrbState
    ...
    def _render_orb_in_frame(self, frame: np.ndarray) -> np.ndarray:
        ...
        try:
            ...
            from core.monica_orb_window import OrbState
